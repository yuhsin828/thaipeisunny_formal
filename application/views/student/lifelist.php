...
<div class="row flex-nowrap">
    ...
    <div class="col-2">
    <img src="/images/student/4_播放按鍵.svg" alt="Image" id="title_pic" 
    onclick="playMp3();"  onmouseover="style='cursor: pointer;width:   50px;height: 50px;;margin-top: 40px;'"
    style="display:inline-block;position: relative;float:left;width:   50px;height: 50px;;margin-top: 40px;">
    </div>
</div>
  <div class="card-body">
    <div class="row align-items-stretch">
          <div class="col-sm-6 align-top">
                <img src="/images/student/3_1_1_1c.jpeg" alt="Image"
                 class="img-fluid rounded float-start" id="main_pic">
          </div>
          
          <div class="col-sm-6 ">
              <div style="margin-top:-50px"> <span>
                  <img src="/images/student/4_播放按鍵.svg"  
                  onmouseover="style='cursor: pointer;display:inline-block;position: relative;float:right;width:   50px;height: 50px;;margin-top: 5px;'"
                  style="display:inline-block;position: relative;float:right;width:   50px;height: 50px;margin-top:5px"
                          onclick="playMp4();"></span>
                          <span>
                     <img src="/images/student/3_1_1_1b.png" alt="Image" id="desc_pic" 
