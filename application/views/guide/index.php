        ...
        <div class="row">
            ...
            <article class="col-md-9 lh-lg">
                ...
                <div class="py-3" id="list-item-1">
                    ...
                    <h6 class="pt-2 fw-bolder">起點｜為什麼會有<span class="bg_lightYellow round_1">國北小泰陽學習資源網</span></h6>
                    <p>
                        2020年初，新冠肺炎（COVID-19）疫情於全球肆虐，<span class="bg_lightYellow round_1">國北小泰陽</span>每年暑假至泰北清萊府華文學校的服務計畫，因此被迫中斷。出團服務對於團隊而言，是十多年以來，每年最為看重的大事，藉由每次為期四到五週的服務，我們與華校師生、當地村民建立了深厚的信任關係與情感連結。面對突如其來的轉變，促使團隊開始思考：我們的下一步是什麼？
                    </p>

                    <h6 class="pt-2 fw-bolder">思考與決定｜我們要怎麼做──架設網站</h6>
                    <p>
                        近年有賴於各界合力，泰北當地的電力供應與網際網路漸趨普及，使小泰陽在臺籌備服務的期間仍得以持續與華校師生保持聯繫，於是我們便開始思考線上服務的可能性。
                        綜合評估當地華校的需求與網路設備條件後，我們於2020年7月架設「<span class="bg_lightYellow round_1">國北小泰陽學習資源網</span>」，將與華文學習、教學相關的資源分門別類，提供給華校的師生，並且藉由網站架構的功能設計，回應學生、教師等不同身分的使用需求。
                    </p>

                    <h6 class="pt-2 fw-bolder">展望｜網站成為穩定維繫的線上平臺</h6>
                    <p>
                        <span class="notoSerif">「值得去做的事，永遠都不會太早或太遲。」──《班傑明的奇幻之旅》</span><br>
                        無論未來團隊是否能夠順利出團至泰北服務，學習資源網將會是小泰陽長期經營、持續更新的線上平臺，與泰北師生共創友善的華文學習園地。藉由網路的無遠弗屆，縮短我們與泰北之間的距離，傳遞我們對泰北的關心。
                    </p>
                </div>
                <!-- 網站沿革 -->
                <div class="py-3" id="list-item-2">
                    ...
                    <p>
                        ...
                        根據華校幼幼班、小學部學生使用的華文教材，我們親自製作輔助的學習素材；同時上架團隊另製的多元主題學習材料，以利學生延伸了解語言在生活中、在中華文化中的樣貌。團隊也於Facebook創立「<span class="bg_lightYellow round_1">國北小泰陽學習資源網_交流板</span>」社團，期待小泰陽能成為更加主動的服務角色，結合社群軟體的傳播力與流通性，與華校學生進行即時的互動與回饋。
                    </p>
                    ...
                    <!-- <h6 class="pt-2 fw-bolder">風格變更｜2022.07 - 2022.10</h6>
                    <p></p> -->
